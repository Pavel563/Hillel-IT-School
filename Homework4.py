...
my_list = [101, 28, 45, 125, 67, 87, 198]
...
my_indexes = [4, 1, 3, 2, 0]
my_list = ["q","w", "e","r", "t"]
for index in my_indexes:
	print(f"Symbol: {my_list[index]}")
...
for symb_1 in my_string:
    for symb_2 in my_string:
        my_result = symb_1 + symb_2
        my_result = int(my_result)
        if (my_result >= 0) and (my_result < 100):
